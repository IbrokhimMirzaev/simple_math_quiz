...
class _MyHomePageState extends State<MyHomePage> {
  ...
  int variantIndex = 0;
  List<int> selectedValues = []; // Har qadamda tanlangan javob indexni saqalaydi
    ...
    return Scaffold(
      ...
      body: Container(
        child: Stack(children: [
          Opacity(opacity: 0.2, child: Image.asset("assets/images/math2.jpg", fit: BoxFit.cover, height: double.infinity)),
          Column(
            children: [
              Expanded(
